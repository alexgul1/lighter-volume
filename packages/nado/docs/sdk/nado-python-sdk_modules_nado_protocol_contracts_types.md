---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/contracts/types.html
---

# Source code for nado_protocol.contracts.types
...
[docs]class NadoNetwork(StrEnum):
    """
...
[docs]class NadoAbiName(StrEnum):
    """
...
[docs]class NadoDeployment(NadoBaseModel):
    """
...
[docs]class DepositCollateralParams(NadoBaseModel):
    """
...
[docs]class NadoExecuteType(StrEnum):
    """
