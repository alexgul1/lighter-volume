---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/engine_client/types/query.html
---

# Source code for nado_protocol.engine_client.types.query
...
[docs]class EngineQueryType(StrEnum):
    """
...
[docs]class QueryStatusParams(NadoBaseModel):
    """
...
[docs]class QueryContractsParams(NadoBaseModel):
    """
...
[docs]class QueryNoncesParams(NadoBaseModel):
    """
...
[docs]class QueryOrderParams(NadoBaseModel):
    """
...
[docs]class QuerySubaccountInfoParams(NadoBaseModel):
    """
...
[docs]class QuerySubaccountOpenOrdersParams(NadoBaseModel):
    """
...
[docs]class QueryMarketLiquidityParams(NadoBaseModel):
    """
...
[docs]class QueryAllProductsParams(NadoBaseModel):
    """
...
[docs]class QueryMarketPriceParams(NadoBaseModel):
    """
...
[docs]class QueryMaxOrderSizeParams(SpotLeverageSerializerMixin):
    """
...
[docs]class QueryMaxLpMintableParams(SpotLeverageSerializerMixin):
    """
...
[docs]class QueryFeeRatesParams(NadoBaseModel):
    """
...
[docs]class QueryHealthGroupsParams(NadoBaseModel):
    """
...
[docs]class QueryLinkedSignerParams(NadoBaseModel):
    """
...
[docs]class ContractsData(NadoBaseModel):
    """
...
[docs]class NoncesData(NadoBaseModel):
    """
...
[docs]class OrderData(NadoBaseModel):
    """
...
[docs]class PreState(NadoBaseModel):
    """
...
[docs]class SubaccountInfoData(NadoBaseModel):
    """
...
[docs]    def parse_subaccount_balance(
        self, product_id: int
...
[docs]class SubaccountOpenOrdersData(NadoBaseModel):
    """
...
[docs]class MarketLiquidityData(NadoBaseModel):
    """
...
[docs]class AllProductsData(NadoBaseModel):
    """
...
[docs]class MarketPriceData(NadoBaseModel):
    """
...
[docs]class MaxOrderSizeData(NadoBaseModel):
    """
...
[docs]class MaxWithdrawableData(NadoBaseModel):
    """
...
[docs]class MaxLpMintableData(NadoBaseModel):
    """
...
[docs]class FeeRatesData(NadoBaseModel):
    """
...
[docs]class HealthGroupsData(NadoBaseModel):
    """
...
[docs]class LinkedSignerData(NadoBaseModel):
    """
...
[docs]class QueryResponse(NadoBaseModel):
    """
