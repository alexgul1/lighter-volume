---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/utils/bytes32.html
---

# Source code for nado_protocol.utils.bytes32
...
[docs]def hex_to_bytes32(input: Union[str, bytes]) -> bytes:
...
[docs]def hex_to_bytes12(input: Union[str, bytes]) -> bytes:
...
[docs]def hex_to_bytes(input: Union[str, bytes], size: int) -> bytes:
...
[docs]def str_to_hex(input: str) -> str:
...
[docs]def subaccount_to_bytes32(
...
[docs]def subaccount_name_to_bytes12(subaccount_name: str) -> bytes:
...
[docs]def bytes32_to_hex(bytes32: bytes) -> str:
...
[docs]def zero_subaccount() -> bytes:
