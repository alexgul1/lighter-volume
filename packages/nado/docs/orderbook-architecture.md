---
url: https://docs.nado.xyz/orderbook-architecture
title: Orderbook Architecture
---
...
- A protocol-level clearinghouse and risk engine housed on-chain.

A protocol-level clearinghouse and risk engine housed on-chain.

- A powerful off-chain sequencer – the central-limit orderbook (CLOB).
