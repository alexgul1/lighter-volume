---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/client/apis/market/query.html
---

# Source code for nado_protocol.client.apis.market.query
...
[docs]class MarketQueryAPI(NadoBaseAPI):
    """
...
[docs]    def get_all_engine_markets(self) -> AllProductsData:
        """
...
[docs]    def get_all_product_symbols(self) -> ProductSymbolsData:
        """
...
[docs]    def get_latest_market_price(self, product_id: int) -> MarketPriceData:
        """
