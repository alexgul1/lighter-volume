---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/contracts.html
---
...
[docs]class NadoContractsContext(BaseModel):
    """
...
[docs]    def claim_usdc_rewards(
    ...
    # TODO: revise once staking contract is deployed
[docs]    def claim_and_stake_usdc_rewards(
        self,
        signer: LocalAccount,
    ) -> str:
        assert self.staking is not None
...
[docs]    def claim_foundation_rewards(
        self,
...
[docs]    def get_token_contract_for_product(self, product_id: int) -> Contract:
        """
...
[docs]    def execute(self, func: ContractFunction, signer: LocalAccount) -> str:
        """
