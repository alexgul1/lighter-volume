---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/client/apis/market/execute.html
---

# Source code for nado_protocol.client.apis.market.execute
...
[docs]class MarketExecuteAPI(NadoBaseAPI):
    """
...
[docs]    def place_trigger_order(self, params: PlaceTriggerOrderParams) -> ExecuteResponse:
...
[docs]    def cancel_trigger_orders(
...
[docs]    def cancel_trigger_product_orders(
...
[docs]    def place_price_trigger_order(
        self,
        product_id: int,
        price_x18: str,
        amount_x18: str,
