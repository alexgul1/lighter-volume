---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/client/apis/spot/query.html
---

# Source code for nado_protocol.client.apis.spot.query
...
[docs]class SpotQueryAPI(BaseSpotAPI):
    """
...
[docs]    def get_token_wallet_balance(self, product_id: int, address: str) -> float:
        """
...
[docs]    def get_token_allowance(self, product_id: int, address: str) -> float:
        """
