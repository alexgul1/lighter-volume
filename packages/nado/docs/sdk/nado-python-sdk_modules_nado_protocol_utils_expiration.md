---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/utils/expiration.html
---

# Source code for nado_protocol.utils.expiration
...
[docs]class OrderType(IntEnum):
    DEFAULT = 0
    IOC = 1
    FOK = 2
    POST_ONLY = 3

[docs]def get_expiration_timestamp(seconds_from_now: int) -> int:
    """
