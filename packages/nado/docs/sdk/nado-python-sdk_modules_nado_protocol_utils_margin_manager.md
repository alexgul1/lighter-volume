---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/utils/margin_manager.html
---
...
[docs]class HealthMetrics(BaseModel):
    """Initial and maintenance health metrics."""

    initial: Decimal
    maintenance: Decimal

[docs]class MarginUsageFractions(BaseModel):
...
[docs]class CrossPositionMetrics(BaseModel):
...
[docs]class IsolatedPositionMetrics(BaseModel):
...
[docs]class AccountSummary(BaseModel):
...
[docs]    def calculate_account_summary(self) -> AccountSummary:
        """
...
[docs]    def calculate_spot_balance_value(self, balance: BalanceWithProduct) -> Decimal:
        """
...
[docs]    def calculate_perp_balance_notional_value(
...
[docs]    def calculate_perp_balance_value(self, balance: BalanceWithProduct) -> Decimal:
        """
...
[docs]    def calculate_spot_balance_health(
        self, balance: BalanceWithProduct
    ) -> HealthMetrics:
        """
...
[docs]    def calculate_perp_balance_health_without_pnl(
        self, balance: BalanceWithProduct
    ) -> HealthMetrics:
        """
...
[docs]    def calculate_cross_position_metrics(
        self, balance: BalanceWithProduct
...
[docs]    def calculate_isolated_position_metrics(
...
[docs]def print_account_summary(summary: AccountSummary) -> None:
