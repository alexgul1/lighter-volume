---
url: https://nadohq.github.io/nado-python-sdk/order-appendix.html
---
...
Use thebuild_appendix()function to create an appendix with the desired parameters:
...
- TWAP Parameters: TWAP orders require bothtwap_timesandtwap_slippage_frac

TWAP Parameters: TWAP orders require bothtwap_timesandtwap_slippage_frac

- Isolated Margin:isolated_margincan only be set whenisolated=True
...
The appendix functions will raiseValueErrorfor invalid configurations:
...
- nado_protocol.utils.order.OrderAppendixTriggerType
