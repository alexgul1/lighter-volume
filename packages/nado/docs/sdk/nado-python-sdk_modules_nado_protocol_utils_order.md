---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/utils/order.html
---

# Source code for nado_protocol.utils.order
...
[docs]class OrderAppendixTriggerType(IntEnum):
    """
...
[docs]def pack_twap_appendix_value(times: int, slippage_frac: float) -> int:
    """
...
[docs]def unpack_twap_appendix_value(value: int) -> tuple[int, float]:
    """
...
[docs]def gen_order_verifying_contract(product_id: int) -> str:
    """
...
[docs]def order_reduce_only(appendix: int) -> bool:
    """
...
[docs]def order_is_trigger_order(appendix: int) -> bool:
    """
...
[docs]def order_is_isolated(appendix: int) -> bool:
    """
...
[docs]def order_isolated_margin(appendix: int) -> Optional[int]:
    """
...
[docs]def order_version(appendix: int) -> int:
    """
...
[docs]def order_trigger_type(appendix: int) -> Optional[OrderAppendixTriggerType]:
    """
...
[docs]def order_twap_data(appendix: int) -> Optional[tuple[int, float]]:
    """
...
[docs]def order_execution_type(appendix: int) -> OrderType:
    """
