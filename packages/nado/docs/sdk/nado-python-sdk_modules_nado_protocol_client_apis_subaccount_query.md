---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/client/apis/subaccount/query.html
---

# Source code for nado_protocol.client.apis.subaccount.query
...
[docs]class SubaccountQueryAPI(NadoBaseAPI):
    """
...
[docs]    def get_engine_subaccount_summary(
...
[docs]    def get_subaccount_fee_rates(self, subaccount: str) -> FeeRatesData:
        """
...
[docs]    def get_subaccount_linked_signer_rate_limits(
        self, subaccount: str
    ) -> IndexerLinkedSignerRateLimitData:
        """
