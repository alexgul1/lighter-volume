---
url: https://nadohq.github.io/nado-python-sdk/getting-started.html
---
...
The primary entry point of the SDK is viacreate_nado_client, which allows you to create an instance ofNadoClient.
SeeAPI Referencefor more details.
...
Places an order viaexecute:place_order.
...
Queries your open orders viaquery:subaccount_orders.
...
The order digest is necessary to perform order cancellation viaclient.market.cancel_orders
...
Cancels open orders viaexecute:cancel_orders.
...
Withdraw spot collaterals from Nado viaexecute:withdraw_collateral.
