---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/contracts/eip712/sign.html
---

# Source code for nado_protocol.contracts.eip712.sign
...
[docs]def build_eip712_typed_data(
...
[docs]def get_eip712_typed_data_digest(typed_data: EIP712TypedData) -> str:
    """
...
[docs]def sign_eip712_typed_data(typed_data: EIP712TypedData, signer: LocalAccount) -> str:
    """
