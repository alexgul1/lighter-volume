---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/contracts/eip712/domain.html
---

# Source code for nado_protocol.contracts.eip712.domain

```python

from nado_protocol.contracts.eip712.types import EIP712Domain

[docs]def get_nado_eip712_domain(verifying_contract: str, chain_id: int) -> EIP712Domain:
    """
...
[docs]def get_eip712_domain_type() -> list[dict[str, str]]:
    """
