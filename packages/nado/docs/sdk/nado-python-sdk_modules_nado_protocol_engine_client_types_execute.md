---
url: https://nadohq.github.io/nado-python-sdk/_modules/nado_protocol/engine_client/types/execute.html
---

# Source code for nado_protocol.engine_client.types.execute
...
[docs]class PlaceOrderParams(SignatureParams):
    """
...
[docs]class CancelOrdersParams(BaseParamsSigned):
    """
...
[docs]class CancelAndPlaceParams(NadoBaseModel):
    """
...
[docs]class WithdrawCollateralParams(BaseParamsSigned):
    """
...
[docs]class LiquidateSubaccountParams(BaseParamsSigned):
    """
...
[docs]class BurnNlpParams(BaseParamsSigned):
    """
...
[docs]class LinkSignerParams(BaseParamsSigned):
    """
...
[docs]class PlaceOrderRequest(NadoBaseModel):
    """
...
[docs]class TxRequest(NadoBaseModel):
    """
...
[docs]class CancelOrdersRequest(NadoBaseModel):
    """
...
[docs]class CancelAndPlaceRequest(NadoBaseModel):
    """
...
[docs]    @validator("cancel_and_place")
...
[docs]class CancelProductOrdersRequest(NadoBaseModel):
    """
...
[docs]class WithdrawCollateralRequest(NadoBaseModel):
    """
...
[docs]    @validator("withdraw_collateral")
...
[docs]class LiquidateSubaccountRequest(NadoBaseModel):
    """
...
[docs]    @validator("liquidate_subaccount")
...
[docs]class MintNlpRequest(NadoBaseModel):
    """
...
[docs]class BurnNlpRequest(NadoBaseModel):
    """
...
[docs]class LinkSignerRequest(NadoBaseModel):
    """
...
[docs]class ExecuteResponse(NadoBaseModel):
    """
